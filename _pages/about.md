...
In broad terms, my work sits at the intersection of:

- **Computational biology & bioinformatics** – working with high-dimensional biological datasets and turning them into interpretable insights, particularly in the field of immune-oncology.
- **Machine learning & AI** – developing and applying models that can learn structure from complex data and generalise across conditions, experiments, and cohorts.
- **Biological knowledge transfer** – exploring how models trained in one context (e.g. a specific dataset, tissue, or species) can help us make predictions or generate hypotheses in another.
...
- How can we build **AI models that capture underlying biological mechanisms**, not just patterns in a single dataset?
- How can we **transfer knowledge** across datasets, technologies, and experimental conditions in a principled way?
- How can we make complex models **interpretable and trustworthy** for biologists and clinicians?
...
- Collaborating in **multidisciplinary teams** with statisticians, computer scientists, and experimental biologists.
- Helping others navigate the interface between **biology and computation**, whether that’s via code review, methods discussions, or informal mentoring.
